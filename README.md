...
| GET | `/languages` | Lista de linguagens coletadas com contagem de repositórios e de vagas abertas |
| GET | `/languages/{lang}/ranking` | Top repos por linguagem (`metric`: stars, engagement, growth) |
| GET | `/languages/{lang}/market` | Vagas de emprego abertas por linguagem (fontes: Adzuna, requer `ADZUNA_APP_ID`/`ADZUNA_APP_KEY`; e RemoteOK, sem credenciais) |
